...
## Calculate J
J = -(1/m) * sum(sum(y_vec.*log(h_x)+(1-y_vec).*log(1-h_x))) + r;

# Back propagation

## Calculate deltas
delta_3 = a_3 - y_vec; # delta_3: 5000x10
delta_2 = (delta_3*Theta2) .* (a_2.*(1-a_2)); # delta2: 5000x26
delta_2 = delta_2(:, 2:end); # remove ones column
